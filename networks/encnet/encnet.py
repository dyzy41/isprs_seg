...
from networks.common_func.seg_func import _FCNHead


class EncNet(nn.Module):
    def __init__(self, in_c, num_class):
        super(EncNet, self).__init__()
        self.head = _EncHead(2048, num_class)
        self.backbone = get_model('resnet50', in_c)
    ...
    def forward(self, x):
        ...
        out = F.interpolate(x[0], size, mode='bilinear', align_corners=True)
        return out
